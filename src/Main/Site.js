    ...
    <div className="animated fadeIn mb-2 relative p-3">
      <div className="p-3 bg-white rounded-sm border-1 border-solid border-gray-400 z-10">
        <div className="flex justify-between mb-4">
          <button className="bg-blue-500 text-white py-1 px-4 rounded" onClick={openModel}>Add Site User Details</button>
          <form className="flex">
            <input
              type="search"
          ...
          <button className="bg-yellow-500 text-white py-1 px-4 rounded">Add Bulk Site Details</button>
        </div>
          ...
          <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
            <div className="bg-white rounded-lg overflow-hidden w-full max-w-2xl">
              <div className="flex justify-between items-center p-4 border-b">
                <h5 className="text-lg font-semibold">{editMode ? 'Edit Site' : 'Add Site'}</h5>
